...
VALUES (
NULL , '$siteurl', '$sitename', '', '', '$sitedesc', 'Y', '1', '0', '0000-00-00 00:00:00', '', '', ''
);");
	echo '<div class="updated fade">New Friend Added !</div>';
}
if ($_POST["action"]=="Save") {
	update_option("ff_size",$_POST["size"]);
	echo '<div class="updated fade">Setting was Saved !</div>';
}
?>
<style>
.own td {padding:5px;}
.owntable {overflow:scroll; height:150px; display:block;}
.owntable tr {background-color:#FFF;}
.owntable td {padding:5px;}
</style>
<div class="wrap">
<?php if(function_exists('screen_icon')) screen_icon(); ?>
<h2>WP Friend Feed</h2>
<em>This page is designed to manage how many site you want to track. Below are your current links on blogroll. This Friend Feed plugins integrate with it and will consider these URL as your bookmarked URLs.</em>
<p>
<form method="post">
Maximum number of feeds to show : <input name="size" size="2" value="<?php echo get_option("ff_size");?>"/>
<input name="action" type="submit" class="button" value="Save" />
</form>
</p>
<div class="own">
...
<tr>
  <td>Site Name</td>
  <td><input name="sitename" size="50" /></td>
</tr>
<tr>
  <td>Site URL</td>
  <td><input name="siteurl" size="50" /></td>
</tr>
<tr>
  <td>Optional Description</td>
	<td><textarea name="sitedesc" cols="40"></textarea></td>
</tr>
</table>
<input type="submit" class="button" value="Add as Friend" name="action"/>
</form>
</div>
<?php
